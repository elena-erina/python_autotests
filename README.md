...
- В папке PytonTests лежит две директории Project1 и tests.
- Project1 содержит файл main.py в котором выполняются автоматизрованные запросы на создание покемона и обновления информации о нем.
- tests содержит файл test_Pokemon.py, в котором осуществляется проверка статус кода запроса (200), и проверка значения trainer_name.


## Локальный запуск тестов (из терминала) 
1. Скачать проект
2. Перейти через терминал в директорию проекта (Project1 или tests)
3. Выполнить команду:
